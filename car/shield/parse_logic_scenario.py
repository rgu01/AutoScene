...
if __name__ == '__main__':
    ...
    # Run the bash script to generate the scenarios
    if run_command("car/shield/generate_scenarios.sh"):
        print("Scenarios generated successfully.")
        # Evaluate the generated scenarios using crime
        gif.evaluate_generated_scenarios("car/shield/generated_scenarios", "car/shield/evaluation_results.txt")
    else:
